...
const projects = [
  {
    ...
    description: "A production AI learning platform with a Knowledge Correction Engine that detects misconceptions and generates targeted remediation paths.",
    metrics: [
      { label: "60–70% returning users", type: "success" },
      { label: "50%+ faster load times", type: "accent" },
      { label: "Live production users", type: "muted" },
    ],
  ...
  },
  {
    ...
    metrics: [
      { label: "60% less manual scheduling", type: "success" },
      { label: "Google Maps + Calendar API", type: "accent" },
      { label: "Stripe payments", type: "muted" },
    ],
  ...
  },
  {
    ...
    metrics: [
      { label: "25% faster revisions", type: "success" },
      { label: "Improved first-pass acceptance", type: "accent" },
    ],
  ...
  },
  {
    ...
    metrics: [
      { label: "40% faster execution", type: "success" },
      { label: "Reduced maintenance complexity", type: "accent" },
    ],
